...
const styles = {
  ...
  topRightButtonContainer: {
    position: 'absolute' as const, // ใช้ 'absolute' เป็นค่าที่ React รองรับ
    top: '10px',
    right: '10px',
  } as React.CSSProperties, // บอก TypeScript ว่าเป็น CSSProperties
  endButton: {
    padding: '10px 20px',
    ...
    fontWeight: 'bold',
    cursor: 'pointer',
  } as React.CSSProperties, // เช่นเดียวกับ endButton
  timestamp: {
    fontSize: "10px",
    color: "#666",
    marginTop: "4px",
